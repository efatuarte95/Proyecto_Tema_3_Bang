...
public class BDPersonajes {
	...
	private Personaje p1 = new Personaje ("Calamity Janet", 4, 1, "Puede usar las cartas ¡BANG! como cartas Fallaste! y las cartas Fallaste! como cartas ¡BANG!. Si Calamity Janet usa una carta Fallaste! como carta ¡BANG!, no puede jugar ningun otro ¡BANG! en el turno (a menos que tenga en juego una Volcanic).");
	private Personaje p2 = new Personaje ("Paul Regret", 3, 1, "Se considera que siempre tiene en juego un Mustang. Todos los demás jugadores deben sumar 1 a la distancia a la que lo ven. Si Paul Regret tiene además un Mustang en juego, los efectos de los dos se suman y la distancia a la que los demás ven a Paul Regret se incrementa en 2.");
	private Personaje p3 = new Personaje ("Rose Doolan", 4, 2, "Se considera que siempre tiene en juego una Mira Telescópica. Rose ve a todos los demás jugadores a una distancia reducida en 1. Si Rose tiene además una Mira Telescópica en juego, los efectos de las dos se suman y reducen la distancia a la que Rose ve a los demás en 2.");
	private Personaje p4 = new Personaje ("Sid Ketchum", 4, 1, "En cualquier momento, puede descartar dos cartas y recuperar 1 punto de vida. Puede hacer esto todas las veces que quiera seguidas, siempre que tenga cartas que descartar. Debes tener en cuenta que no se pueden tener más puntos de vida por encima de los iniciales.");
